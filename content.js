...
document.getElementsByTagName("body")[0].innerHTML += "<div id='custom_calc_wrap' style='display:none'><h1 id='calc'>Kalkulaator</h1><div id='calc_html' ></div></div>";

window.addEventListener('keypress', function(e){
	console.log(e);
    if(e.key == "k"){
        document.getElementById('custom_calc_wrap').style.display = "block";
    }else if(e.key == "h"){
        document.getElementById('custom_calc_wrap').style.display = "none";
    }
});
...
xhr.onreadystatechange = function() {
  if (this.readyState == 4) {
	...
	var ele = document.getElementById ("custom_calc_wrap");
